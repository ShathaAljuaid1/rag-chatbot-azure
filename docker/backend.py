...
DB_CONFIG = {
    "dbname": secret_client.get_secret("PROJ-DB-NAME").value,
    "user": secret_client.get_secret("PROJ-DB-USER").value,
    "password": secret_client.get_secret("PROJ-DB-PASSWORD").value,
    "host": secret_client.get_secret("PROJ-DB-HOST").value,
    "port": secret_client.get_secret("PROJ-DB-PORT").value,
}

openai_api_key = secret_client.get_secret("PROJ-OPENAI-API-KEY").value
...
chroma_host = secret_client.get_secret("PROJ-CHROMADB-HOST").value
chroma_port = int(secret_client.get_secret("PROJ-CHROMADB-PORT").value)
...
storage_account_sas_url = secret_client.get_secret(
    "PROJ-AZURE-STORAGE-SAS-URL"
).value

storage_container_name = secret_client.get_secret(
